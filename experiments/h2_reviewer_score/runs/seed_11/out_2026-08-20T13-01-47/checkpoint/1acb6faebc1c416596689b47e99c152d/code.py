...
def main():
    ...
    plan = ExperimentPlan(plan_name='movielens100k_itemknn_vs_popularity')
    plan.add_algorithm(
    ...
    ax = pivot.plot(kind='bar', x='algorithm', figsize=(8, 4), rot=20)
    ax.set_ylabel('Score')
    ax.set_title('MovieLens100K: ItemKNN vs Popularity @10')
    ax.legend(title='Metric')
    plt.tight_layout()

    plot_path = Path(working_dir) / 'movielens100k_itemknn_popularity_metrics.png'
